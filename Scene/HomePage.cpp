...
bool HomePage::init()
{
	...
	for (int i = 0; i < 10; i++) {
		...
		leftArrow->setPosition(Vec2((i % 5 + 1) * (origin.x + visibleSize.width) / 6 - (origin.x + visibleSize.width) / 18 - 5,
									(i / 5 + 1) * (origin.y + visibleSize.height) / 3 + (origin.y + visibleSize.height) / 6));

		menu->addChild(leftArrow);


		rightArrow->setPosition(Vec2((i % 5 + 1) * (origin.x + visibleSize.width) / 6 + (origin.x + visibleSize.width) / 18 + 8,
									 (i / 5 + 1) * (origin.y + visibleSize.height) / 3 + (origin.y + visibleSize.height) / 6));
	...
	startGameItem->setPosition(Vec2(origin.x + visibleSize.width / 2, 
									origin.y + visibleSize.height / 4 - 40));
